...
- Claude Code: `%USERPROFILE%\.local\bin\claude.exe`, version `2.1.214`.
- Kimi Code: `%USERPROFILE%\.kimi-code\bin\kimi.exe`, version `0.27.0`.
- Grok Build: `%USERPROFILE%\.grok\bin\grok.exe`, version `0.2.103`.
- Grok alias: `%USERPROFILE%\.grok\bin\agent.exe`, same version as `grok`.

Windows user PATH entries added:

```text
%USERPROFILE%\.local\bin
%USERPROFILE%\.kimi-code\bin
